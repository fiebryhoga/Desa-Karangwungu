...
export default function PageHeader({
    ...
    return (
        <div
            className={`relative rounded-xl overflow-hidden shadow-xl border border-red-500/40 bg-gradient-to-r from-red-800 via-red-700 to-red-900 text-white ${className}`}
        >
