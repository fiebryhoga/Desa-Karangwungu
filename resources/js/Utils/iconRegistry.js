...
export const ICON_REGISTRY = {
    ...
    ShieldAlert: { icon: ShieldAlert, label: 'Perisai Siaga / Linmas / Ketertiban', category: 'Sosial & Masyarakat' },
    Flame: { icon: Flame, label: 'Api / Pemuda / Karang Taruna', category: 'Sosial & Masyarakat' },
